...
Приложение доступно по ссылке http://51.250.39.233:3000/hw/store/

По любым вопросам насчет домашки пишите в тг @ern_sakh :)

Во время выполнения домашки я много раз запускал флоу, из-за чего на данный момент версия релиза - гораздо выше 40)
Это можно пофиксить, пересоздав флоу, но я не стал этим заниматься.
